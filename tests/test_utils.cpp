...
int test_is_rtsp_header() {
    ...
    char header4[] = "HTTP/1.0 200 OK\r\n\r\n";
    ASSERT_EQUAL(1, is_rtsp_http_header(header1, sizeof(header1)),
                 "Expected 1 for header1");
    ASSERT_EQUAL(0, is_rtsp_http_header(header2, sizeof(header2)),
                 "Expected 0 for header2");
    ASSERT_EQUAL(1, is_rtsp_http_header(header3, sizeof(header3)),
                 "Expected 1 for header3");
    ASSERT_EQUAL(1, is_rtsp_http_header(header4, sizeof(header4)),
