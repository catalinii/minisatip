...
int test_assemble_packet_adaptation() {
    ...
    ASSERT_EQUAL(0x02, f.data[0], "asemble_packet failed when using adaptation on first byte")
    return 0;
}
...
int test_assemble_packet() {
    ...
    ASSERT_EQUAL(0x80, f.data[0], "asemble_packet failed without adaptation failed on first byte")
    return 0;
}

int test_assemble_multi_packet() {
    unsigned char p1[] = {0x47, 0x40, 0x11, 0x12, 0x0, 0x42, 0xf1, 0x5, 0x0, 0xe8, 0xc5, 0x0, 0x0, 0x0, 0x1, 0xff, 0x0, 0xd2, 0xfd, 0x80, 0x12, 0x48, 0x10, 0x1, 0x4, 0x44, 0x49, 0x47, 0x49, 0x9, 0x46, 0x69, 0x6c, 0x6d, 0x20, 0x43, 0x61, 0x66, 0x65, 0x1, 0x57, 0xfd, 0x90, 0x14, 0x48, 0x12, 0x1, 0x4, 0x44, 0x49, 0x47, 0x49, 0xb, 0x46, 0x49, 0x4c, 0x4d, 0x20, 0x4e, 0x4f, 0x57, 0x20, 0x48, 0x44, 0x1, 0x72, 0xfd, 0x80, 0x12, 0x48, 0x10, 0x1, 0x4, 0x44, 0x49, 0x47, 0x49, 0x9, 0x41, 0x58, 0x4e, 0x20, 0x57, 0x68, 0x69, 0x74, 0x65, 0x1, 0x7c, 0xfd, 0x80, 0x14, 0x48, 0x12, 0x1, 0x4, 0x44, 0x49, 0x47, 0x49, 0xb, 0x4e, 0x69, 0x63, 0x6b, 0x65, 0x6c, 0x6f, 0x64, 0x65, 0x6f, 0x6e, 0x1, 0xa6, 0xfd, 0x80, 0x12, 0x48, 0x10, 0x1, 0x4, 0x44, 0x49, 0x47, 0x49, 0x9, 0x4e, 0x69, 0x63, 0x6b, 0x74, 0x6f, 0x6f, 0x6e, 0x73, 0x1, 0xcc, 0xff, 0x80, 0xe, 0x48, 0xc, 0x1, 0x4, 0x44, 0x49, 0x47, 0x49, 0x5, 0x4d, 0x45, 0x5a, 0x5a, 0x4f, 0x2, 0x61, 0xfd, 0x80, 0xc, 0x48, 0xa, 0x1, 0x4, 0x44, 0x49, 0x47, 0x49, 0x3, 0x43, 0x4e, 0x4e, 0x2, 0x83, 0xfd, 0x90, 0x14, 0x48, 0x12, 0x1, 0x4, 0x44, 0x49, 0x47, 0x49, 0xb, 0x53, 0x75, 0x70};
    unsigned char p2[] = {0x47, 0x0, 0x11, 0x11, 0x65, 0x72, 0x4f, 0x4e, 0x45, 0x20, 0x48, 0x44, 0x2, 0x8c, 0xfd, 0x90, 0xf, 0x48, 0xd, 0x1, 0x4, 0x44, 0x49, 0x47, 0x49, 0x6, 0x48, 0x42, 0x4f, 0x20, 0x48, 0x44, 0x1f, 0x18, 0xfd, 0x80, 0x13, 0x48, 0x11, 0x6, 0x4, 0x44, 0x49, 0x47, 0x49, 0xa, 0x53, 0x57, 0x20, 0x44, 0x4c, 0x20, 0x53, 0x4d, 0x49, 0x54, 0x1f, 0x4a, 0xfd, 0x80, 0x14, 0x48, 0x12, 0x6, 0x4, 0x44, 0x49, 0x47, 0x49, 0xb, 0x53, 0x57, 0x20, 0x53, 0x6d, 0x61, 0x72, 0x74, 0x44, 0x54, 0x56, 0x31, 0x62, 0xad, 0xf5, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff};
    SFilter f;
    f.id = 0;
    f.enabled = 1;
    f.flags = FILTER_CRC;
    int data = assemble_packet(&f, p1);
    ASSERT_EQUAL(data, 0, "asemble_packet expected length 0 for the first packet")
    data = assemble_packet(&f, p2);
    printf("Got %d from assemble_packet\n", data);
    ASSERT_EQUAL(264, data, "asemble_packet failed for multi-packet")
    ASSERT_EQUAL(0x42, f.data[0], "asemble_packet failed without adaptation failed on first byte")
    return 0;
}
...
int main() {
    ...
    TEST_FUNC(test_assemble_multi_packet(), "testing assemble_packet with multiple packets");
    fflush(stdout);
    return 0;
}
